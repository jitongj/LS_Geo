#' Make_Separated_D_Spherical_3D function
#'
#' @param K number of cliques
#' @param n size of graph
#' @param kappa curvature of latent space
#' @param ub_theta upper bound for distribution of theta angle for points in  spherical LS
#' @param ub_phi upper bound for distribution of phi angle for points in  spherical LS
#' @param delta controls the spread of the nodes around their group centers in spherical LS
#'
#' @return list of matrix DGroups and matrix D
#' @export
