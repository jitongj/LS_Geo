...
#'
#' @param Y a matrix
#' @param cliques cliques of matrix
#' @param clique_size size od clique
#' @param K number of cliques
#' @param E_nu a nu ber
#' @param J a matrix
#' @param lambdaHat estimate
#' @param alpha a nmber
#' @param m size - 1
#' @param geometry type of space
#' @param kappa curvature of latent space
#' @param rate rate used when sub-sampling
#' @param zeta scaling in front of distances
#'
#' @return list of True/False, p-value
#' @export
